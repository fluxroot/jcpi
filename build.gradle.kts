...
publishing {
	...
	repositories {
		maven {
			val releasesRepository = uri("https://oss.sonatype.org/service/local/staging/deploy/maven2/")
			val snapshotRepository = uri("https://oss.sonatype.org/content/repositories/snapshots/")
